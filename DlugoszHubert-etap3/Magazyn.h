...
{
private:
	static Kontener<std::string> _sharedProducts;			//vector przechowujacy nazwy wszystkich produktow we wszystkich magazynach
	static Kontener<int>  _sharedProductsID;				//vector przechowujacy ID wszystkich produktow we wszystkich magazynach
